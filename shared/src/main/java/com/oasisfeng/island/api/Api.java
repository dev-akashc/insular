...
public class Api {
	...
	interface v2 extends v1 {
		...
		String PERMISSION_FREEZE_PACKAGE = "com.akash.island.permission.FREEZE_PACKAGE";
		String PERMISSION_LAUNCH_PACKAGE = "com.akash.island.permission.LAUNCH_PACKAGE";
		String PERMISSION_SUSPEND_PACKAGE = "com.akash.island.permission.SUSPEND_PACKAGE";
		 ...
		 * <p>Result: {@link Activity#RESULT_OK} for success, {@link Activity#RESULT_CANCELED} for failure or {@link latest#RESULT_UNVERIFIED_IDENTITY}
		 */
		@Since(2.1) @RequiresPermission(PERMISSION_SUSPEND_PACKAGE) String ACTION_SUSPEND = "com.akash.island.action.SUSPEND";

		/**
		 * Unsuspend the app(s) specified by Intent data with "package" or "packages" (comma-separated) scheme. (requires Android N+)
		 * <p>Result: {@link Activity#RESULT_OK} for success, {@link Activity#RESULT_CANCELED} for failure or {@link latest#RESULT_UNVERIFIED_IDENTITY}
		 */
		@Since(2.1) @RequiresPermission(PERMISSION_SUSPEND_PACKAGE) String ACTION_UNSUSPEND = "com.akash.island.action.UNSUSPEND";
	...
	interface v1 {
		@Since(1.0) String ACTION_FREEZE   = "com.akash.island.action.FREEZE";
		@Since(1.1) String ACTION_UNFREEZE = "com.akash.island.action.UNFREEZE";
		...
		@Since(1.1) String ACTION_LAUNCH   = "com.akash.island.action.LAUNCH";
