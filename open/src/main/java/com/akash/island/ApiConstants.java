...
@SuppressLint("InlinedApi") public class ApiConstants {
	 ...
	 */
	static final String TYPE_DELEGATION = "com.akash.island.delegation";	// Name-spaced as requirement mentioned by RestrictionsManager.requestPermission()
	 ...
	 */
	public static final String REQUEST_KEY_USER_SERIAL_NUMBER = "com.akash.island.request.user";
